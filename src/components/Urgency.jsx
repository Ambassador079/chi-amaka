...
const URGENCY_PHRASES = [
  "Blink and it’s gone — don’t miss this 🔥",
  "People are ordering RIGHT NOW ⚡",
  "This is your moment… don’t fumble 😤",
  "Only a few orders left — act fast 👀",
];
      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        ...
        <ScrollReveal variant="scaleIn">
          <div className="mb-6">
            ...
            {status === "closed" && (
              <span className="bg-red-500/20 text-red-400 px-5 py-2 rounded-full text-sm font-semibold">
                🔒 Currently Closed
              </span>
            )}
          </div>
        ...
        <p className="text-white/60 mb-10">
          Available only on weekends from{" "}
        ...
        {status === "open" && (
          <motion.a
            ...
            className="inline-flex items-center gap-3 bg-gradient-to-r from-brand-orange to-brand-red text-white px-8 py-4 rounded-full font-bold"
          >
            🍽️ Order Now
          </motion.a>
        )}
